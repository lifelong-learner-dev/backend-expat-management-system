...
from .serializers import ExplanationSerializer, DocumentSerializer, Visit_placeSerializer, Driving_licenseDetailSerializer, Driving_licenseListSerializer
            ...
            try:
                with transaction.atomic():
                    ...
                    for explanation_pk in explanations:
                        ...
                        driving_license.explanations.add(explanation)
                    documents = request.data.get("documents")
                    for document_pk in documents:
                        document = Document.objects.get(pk=document_pk)
                        driving_license.documents.add(document)    
