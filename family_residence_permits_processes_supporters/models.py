...
class Family_residence_permits_processes_supporter(CommonModel):
    ...
    responsible_person = models.ForeignKey(
        ...
        related_name="family_residence_permits_processes_supporters",
        default="",
    )

    def __str__(self):
        return "Family residence permits processes supporter"
    
    class Meta:
        verbose_name_plural = "Family residence permits processes supporters"