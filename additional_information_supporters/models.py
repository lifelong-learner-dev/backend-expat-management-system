...
class Additional_information_supporter(CommonModel):
    ...
    responsible_person = models.ForeignKey(
        ...
        related_name="additional_information_supporters",
        default="",
    )

    def __str__(self):
        return "Additional information supporter"
    
    class Meta:
        verbose_name_plural = "Additional information supporters"
