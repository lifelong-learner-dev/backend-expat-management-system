...
CUSTOM_APPS = [
    ...
    "company_cars_supporters.apps.CompanyCarsSupportersConfig",
    ...
    "family_residence_permits_processes_supporters.apps.FamilyResidencePermitsProcessesSupportersConfig",
