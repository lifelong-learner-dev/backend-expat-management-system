...
urlpatterns = [
    ...
    path('api/v1/family_residence_permits_processes/', include('family_residence_permits_processes.urls')),
    path('api/v1/family_residence_permits_processes_supporters/', include('family_residence_permits_processes_supporters.urls')),   
    ...
    path('api/v1/driving_licenses_processes/', include('driving_licenses_processes.urls')),
